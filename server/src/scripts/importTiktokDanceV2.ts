...
const FOLDER_ID = '1ZwNbjrdSzh0AS8GyzoUHo5l6IAUI9m-w';
...
const Track = sequelize.define('Track', {
  ...
  genre:      { type: DataTypes.STRING, defaultValue: 'TikTok Dance' },
...
function parseFilename(name: string) {
  ...
  // No artist - title pattern, just use filename as title
  return { artist: 'Various Artists', title: base, version: '', versionType: 'clean' };
}
